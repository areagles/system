...
STAGE_NAME="owner-system-final-${STAMP}"
...
cp "${ROOT_DIR}/LICENSE_PROFILE_OWNER.env.example" "${STAGE_DIR}/.app_env.template"
echo "owner" > "${STAGE_DIR}/EDITION.txt"
...
echo "OWNER_FINAL_PACKAGE=${ZIP_PATH}"
